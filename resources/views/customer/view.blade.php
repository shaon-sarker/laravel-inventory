                                            ...
                                            <tbody>
                                                @foreach ($customers as $customer_info)
                                                    <tr>
                                                        ...
                                                        <td>{{ $customer_info->shopname }}</td>
                                                        <td><img width="50%"
                                                                src="{{ asset('uploads/customers') }}/{{ $customer_info->photo }}"
                                                                alt=""></td>
                                                        <td>{{ $customer_info->account_holder }}</td>
                                                        <td>{{ $customer_info->account_number }}</td>
                                                        <td>{{ $customer_info->branch_name }}</td>
                                                        <td>{{ $customer_info->bank_name }}</td>
                                                        <td>
                                                        ...
                                                        <td class="actions pr-5">
                                                            <a href="{{ url('/customer/edit') }}/{{ $customer_info->id }}"
                                                                class="on-default edit-row"><i
                                                                    class="fa fa-pencil"></i></a>
                                                            <a href="{{ url('/employee/delete') }}/{{ $customer_info->id }}"
